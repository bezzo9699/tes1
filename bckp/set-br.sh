...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/Bezzo9699/tes1/main/bckp/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/Bezzo9699/tes1/main/bckp/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/Bezzo9699/tes1/main/bckp/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/Bezzo9699/tes1/main/bckp/logcleaner.sh" && chmod +x /usr/bin/cleaner
