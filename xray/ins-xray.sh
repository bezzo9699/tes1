...
#wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/Bezzo9699/tes1/main/dll/bbr.sh"
#chmod +x /usr/bin/bbr
#bbr >/dev/null 2>&1
...
sleep 1
wget -q -O /usr/bin/add-ws "https://raw.githubusercontent.com/Bezzo9699/tes1/main/xray/add-ws.sh" && chmod +x /usr/bin/add-ws
